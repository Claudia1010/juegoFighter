...
let seleccion = (jugador) => {//jugador nro de 1 a 4
  ...
  const pelear = () => {
    ...
    if (grupo1.vida <= 0) {
      ...
      winner.innerHTML = `<img class="winner" src="img/${grupo2.nombre}.png" alt ="winner"> </br> The winner is Player 2 with ${grupo2.nombre}!`;
    }
    if (grupo2.vida <= 0) {
        screenSwitch(4);
   
      winner.innerHTML = `<img class="winner" src="img/${grupo1.nombre}.png" alt="winner" > </br> The winner is Player 1 with ${grupo1.nombre}!`;
    }
